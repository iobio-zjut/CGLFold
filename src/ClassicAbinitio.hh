...
//	void Output_pdb_Local(vector<core::pose::Pose> &population);
	...
	vector<Real> calculate_population_energy(vector<core::pose::Pose> &population);
	vector<Real> calculate_population_Cscore(vector<core::pose::Pose> &population);
	
	void Global_search(vector<core::pose::Pose> &population, vector<Real> &population_energy, vector<Real> &population_Cscore);
	void Local_search(vector<core::pose::Pose> &population, vector<Real> &population_energy, vector<Real> &population_Cscore, LJAngleRotationOP LJAR);
